...
| Beer reference type | cross-backend pointer, **not a hard FK** (per ADR-0005 / ADR-0006) | unchanged |
...
|---|---|---|
| **P0 — Spec & UML (this deliverable)** | This document + 6 Mermaid diagrams + ADR-0006 | Merged; epic + sub-issues filed |
