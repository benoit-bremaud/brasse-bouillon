...
| [0011](0011-creator-role-above-admin.md) | Single-holder `CREATOR` role above `ADMIN` | Accepted | 2026-06-15 |
...
| [0015](0015-beer-ingestion-enrichment-strategy.md) | Beer ingestion & enrichment strategy (multi-source → staging → human-gated promotion) | Accepted | 2026-06-15 |
