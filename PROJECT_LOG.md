...
- **Conditional OCR ensemble over systematic ensemble**: single grayscale pass first, escalate to 5-channel ensemble only when confidence on critical fields is below 0.7. Cost stays at ~0.6 cent/scan in the common case.
