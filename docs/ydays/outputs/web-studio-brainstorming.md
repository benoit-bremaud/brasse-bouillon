...
**Source** : exploration du repo `/home/vev/Documents/web-studio` par
l'assistant le 2026-04-19 (22 commits, dernier aujourd'hui, nom de la
marque = **Eryon**, stack Next.js 16 + TypeScript strict + Tailwind v4 +
shadcn/ui, repo en phase setup, pas de contenu marketing public ni de
pricing documenté).

## Résumé de l'état actuel Eryon (2026-04-19)

- **Nom** : Eryon
- **Cible documentée** : TPE, artisans, associations locales (Alpes-Maritimes
  au lancement)
- **Services documentés** : sites vitrines, blogs, e-commerce (SaaS différé)
- **Méthode** : IA-driven, livraison rapide, solo fullstack, pas de
  sous-traitance
- **Ce qui existe** : repo propre, CI/lint strict, guide d'interview client
  complet (15 blocs + 3 modules projet), page d'accueil placeholder
- **Ce qui manque** : pricing, ICP chiffré, positionnement narratif public,
  plan GTM, lien explicite avec Brasse-Bouillon, vision équipe/solo long
  terme

## 15 questions structurées

Questions organisées en 5 thèmes. Chaque réponse sera consignée ici au
fil du brainstorming. **Priorité** = ordre d'attaque suggéré.

### Thème A — Vision & Branding
...
9. Combien de projets peux-tu livrer par trimestre en solo réaliste ?
   (Donnée clé pour chiffrer le CA an 1.)
   - *Réponse :*

### Thème D — GTM & Acquisition

10. **[Priorité 4]** Canal d'acquisition primaire an 1 : (a) bouche-à-
...
À alimenter une fois les 15 réponses consignées. Structure prévue dans
[plan-presentation-27-mai.md](plan-presentation-27-mai.md) bloc 5 :

- **Perspectives RH** (remplace SMART #31) : "Je crée Eryon, mon propre
  studio web, pour porter Brasse-Bouillon et accueillir d'autres
  projets. Positionnement : < à compléter >, cible : < à compléter >,
  premier jalon : < à compléter >."
- **Lien avec Brasse-Bouillon** : BB = < 1er client interne /
  portfolio / projet parallèle > pour Eryon.
...
- Repo Eryon : `/home/vev/Documents/web-studio/` (hors monorepo
  Brasse-Bouillon)
- Plan soutenance : [plan-presentation-27-mai.md](plan-presentation-27-mai.md)
- Debrief ayant acté le pivot :
  [../debrief/2026-04-19_session-decisions.md](../debrief/2026-04-19_session-decisions.md)
- Exploration du repo : agent Explore 2026-04-19 (résultat résumé
  ci-dessus)
