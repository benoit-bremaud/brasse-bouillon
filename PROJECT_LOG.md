...
- Reviews — two adversarial pre-push reconciliation rounds (year-fallback MUST-fix, `retry:false` simplification, badge-uppercase test assertions); Copilot no-data wording corrected. CI green, 0 unresolved threads.
