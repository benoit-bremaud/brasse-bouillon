...
See [docs/diagrams/beer-encyclopedia/](docs/diagrams/beer-encyclopedia/) for the UML conception study (use-case, sequence, component, class, state, data-flow) — kept in-package per repo ADR-0013.
