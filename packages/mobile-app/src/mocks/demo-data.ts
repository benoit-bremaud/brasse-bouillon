...
export const demoEquivalentRecipes: Record<string, ScanRecipeMatch[]> = {
  "5060277380011": [
    {
      recipeId: "demo-recipe-punk-ipa-clone",
      name: "Punk IPA Clone — version tropicale",
      brewer: "Marie",
      rating: 4.7,
      brewedCount: 23,
      score: 0.95,
    ...
    {
      recipeId: "demo-recipe-punk-ipa-citra",
      name: "BrewDog Punk Style — Citra forward",
      brewer: "Antoine",
      rating: 4.5,
      brewedCount: 18,
      score: 0.89,
    ...
    {
      recipeId: "demo-recipe-punk-ipa-session",
      name: "Session IPA inspirée de Punk",
      brewer: "Lucas",
      rating: 4.3,
      brewedCount: 12,
      score: 0.78,
  ...
  "5410702000132": [
    {
      recipeId: "demo-recipe-chouffe-blonde",
      name: "La Chouffe Blonde maison",
      brewer: "Caroline",
      rating: 4.8,
      brewedCount: 31,
      score: 0.93,
    ...
    {
      recipeId: "demo-recipe-chouffe-coriandre",
      name: "Belgian Strong Pale — épices coriandre",
      brewer: "Hugo",
      rating: 4.6,
      brewedCount: 19,
      score: 0.86,
    ...
    {
      recipeId: "demo-recipe-chouffe-light",
      name: "Achouffe-style — version 6%",
      brewer: "Sophie",
      rating: 4.2,
      brewedCount: 9,
      score: 0.74,
  ...
  "5410799000111": [
    {
      recipeId: "demo-recipe-rochefort-10",
      name: "Rochefort 10 Clone trappiste",
      brewer: "Pierre",
      rating: 4.9,
      brewedCount: 27,
      score: 0.97,
    ...
    {
      recipeId: "demo-recipe-rochefort-quad",
      name: "Belgian Quadrupel — sucre candi",
      brewer: "Nathalie",
      rating: 4.7,
      brewedCount: 22,
      score: 0.91,
    ...
    {
      recipeId: "demo-recipe-rochefort-dark",
      name: "Quad foncée — fruits secs",
      brewer: "Mehdi",
      rating: 4.4,
      brewedCount: 14,
      score: 0.81,
